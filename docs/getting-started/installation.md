...
| bd (Beads CLI) | Yes | 1.0.4 minimum; 1.3.0 tested with Gas City 1.4.2 | `brew install beads` | [releases](https://github.com/gastownhall/beads/releases) | Issue tracking |
