...
| Audit baseline | all tracked test source | subprocess: 649 calls / 188 files (historical regex census: 495 / 135) | ga-80po0c.2 | tracked test source totals remain visible as audit evidence; ga-80po0c.2 owns this point-in-time source census; the dc-old absorption (gct-p5v2d) added one reviewed exec.Command('sh', ...) call in the new examples/bd/dolt/cleanup_test.go, which exercises the real cleanup script end-to-end | P0.4a | 2026-10-01 |
...
| Small debt ratchet | all untagged test source | subprocess: 429 calls / 122 files (historical regex census: 394 / 105) | ga-80po0c.2.1 | untagged Small subprocess call/file totals cannot grow; reductions must lower this baseline; non-Medium lexical owners remove or replace each process call site; the dc-old absorption (gct-p5v2d) added one reviewed exec.Command('sh', ...) call in the new examples/bd/dolt/cleanup_test.go, which exercises the real cleanup script end-to-end | D1/D2/D5/D6/E6 | 2026-10-01 |
...
| Source debt ratchet | all untagged test source | subprocess: 436 calls / 126 files (historical regex census: 380 / 98) | ga-80po0c.2 | untagged subprocess call/file totals cannot grow; reductions must lower this baseline; each process-owning test removes or replaces its source call site; the dc-old absorption (gct-p5v2d) added one reviewed exec.Command('sh', ...) call in the new examples/bd/dolt/cleanup_test.go, which exercises the real cleanup script end-to-end | D1/D2/D5/D6/E6 | 2026-10-01 |
